...
ldr		r0, =PERIPH_BB_BASE+(RCC_APB2ENR-PERIPH_BASE)*32+2*4
	...
	ldr		r9, =0x1FFF				//задержка между числами
...
add_counter:
	tst 	r12, #1 					//проверка порядка счета вверх/вниз
	ite 	eq
	addeq 	r10, #1
	subne 	r10, #1

	cmp 	r10, #10					//проверка на переполнение первой цифры
	itt 	eq
	moveq 	r10, #0
	addeq 	r11, #1

	cmp 	r10, #-1					//проверка на переполнение первой цифры
	itt 	eq
	moveq 	r10, #9
	subeq 	r11, #1

	cmp 	r11, #4						//проверка на переполнение второй цифры
	ittt 		eq
	moveq 	r11, #3
	moveq 	r12, #1
	moveq 	r10, #9

	cmp 	r11, #-1					//проверка на переполнение второй цифры
	ittt 		eq
	moveq 	r10, #0
	moveq 	r11, #0
	moveq 	r12, #0
...
delay:									@ Подпрограмма задержки
	...
	ldr		r0, =0xF					@ псевдоинструкция Thumb (загрузить константу в регистр)
delay_loop:
...
clear:
	...
	str r2, [r0]
check_conunteri:
	cmp r10, #0							//сравнение счетчика с конкретной цифрой
	it eq								//если совпало то...
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS4|GPIO_BSRR_BS5|GPIO_BSRR_BS7|GPIO_BSRR_BS9
	cmp 	r10, #1
	it eq
	ldreq r2, =GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS9

	cmp r10, #2
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS6|GPIO_BSRR_BS4|GPIO_BSRR_BS3|GPIO_BSRR_BS9

	cmp r10, #3
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS6|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS9

	cmp r10, #4
	it eq
	ldreq r2, =GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS9

	cmp r10, #5
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS9

	cmp r10, #6
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS4|GPIO_BSRR_BS9

	cmp r10, #7
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS9
	cmp r10, #8
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS4|GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS7|GPIO_BSRR_BS9
	cmp r10, #9
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS7|GPIO_BSRR_BS9
	bx 		lr
check_countero:
	cmp r11, #0
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS4|GPIO_BSRR_BS5|GPIO_BSRR_BS7|GPIO_BSRR_BS8
	cmp r11, #1
	it eq
	ldreq r2, =GPIO_BSRR_BS1|GPIO_BSRR_BS2|GPIO_BSRR_BS8
	cmp r11, #2
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS6|GPIO_BSRR_BS4|GPIO_BSRR_BS3|GPIO_BSRR_BS8
	cmp r11, #3
	it eq
	ldreq r2, =GPIO_BSRR_BS0|GPIO_BSRR_BS1|GPIO_BSRR_BS6|GPIO_BSRR_BS2|GPIO_BSRR_BS3|GPIO_BSRR_BS8
	bx 		lr
